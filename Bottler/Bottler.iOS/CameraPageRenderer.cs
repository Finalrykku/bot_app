...
[assembly: ExportRenderer(typeof(Bottler.CameraPage), typeof(CameraPageRenderer))]
namespace Bottler.iOS
{
    public class CameraPageRenderer : PageRenderer
    {
        ...
        private void SetupEventHandlers()
        {
            ...
            {
                (Element as Bottler.CameraPage).Cancel();
            };
            ...
            takePhotoButton.TouchUpInside += async (s, e) =>
            {
                ...
                (Element as Bottler.CameraPage).SetPhotoResult(data.ToArray(),
